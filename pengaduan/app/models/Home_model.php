...
class Home_model
{
    ...
    public function getPengaduanNIK($nik)
    {
    ...
    public function deletePengaduan($nik)
    {
        $query = 'DELETE FROM `pengaduan` where nik=' . $nik;
        $dbcontroller = new DBController();
        $this->memory = $dbcontroller->executeQuery($query);
        return $this->memory;
    }

    public function deleteTanggapan($id_peg)
    {
        $query = 'DELETE FROM `tanggapan` where id_peg=' . $id_peg;
        $dbcontroller = new DBController();
        $this->memory = $dbcontroller->executeQuery($query);
        return $this->memory;
    }
