    ...
    <script type="text/javascript">
        ...
        function type(hasil) {
            ...
            if (hasil == 0) {
                ...
                display.setAttribute("style", "color:#34ff27")
            }
            if (hasil == 1) {
            ...
            if (hasil == 2) {
                ...
                display.setAttribute("style", "color:#ffe927")
            }
        }
...
<body>
        ...
        <div class="card w-50 text-white position-absolute top-50 start-50 translate-middle" style="background-color:#00a92c">
            <div class="card-body">
                <h1 style="text-decoration:underline">Tambah User</h1>
                <form action="../register/input/1" method="post" id="form">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="username" placeholder="Username..." onkeyup="ketik()" onclick="ketik()" name="username" value="">
                        <p id="userCheck"></p>
