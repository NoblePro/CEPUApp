    ...
    <script type="text/javascript">
        ...
        $(function() {
            $("#form").submit(function(e) {
                ...
                if (username != '' && nama != '' && telpon != '' && nik != '' && test == 'Username Tersedia!') {
                    $("#form").submit()
                } else {
                    e.preventDefault()
                }
        ...
        function ketik() {
            ...
            var idnya = $("#id").val()
            $.ajax({
                url: 'http://localhost/pengaduan/public/ajax/edit.php',
                method: 'post',
                data: {
                    username: input,
                    id: idnya
...
<body>
        ...
        <div class="card w-50 text-white position-absolute top-50 start-50 translate-middle" style="background-color:#00a92c">
            ...
            <form action="../update" method="post" id="form">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="username" placeholder="Username..." onkeyup="ketik()" onclick="ketik()" name="username" value="<?= $data['username']; ?>">
                    <p id="userCheck" style="color:orange;">Mohon Mengetik Ulang Username!</p>
                    <p style="color:red;" id="username-display">Mohon mengecek Username!</p>
                </div>
                <div class="mb-3">
                    <label for="password" class="form-label">Password</label>
                    <input type="password" class="form-control" id="password" placeholder="Password Tidak Diubah..." name="password">
                    <input type="hidden" value="<?= $data['password']; ?>" name="prev-pass">
                </div>
                <div class="mb-3">
                    <label for="Telpon" class="form-label">Telpon</label>
                    <input type="text" class="form-control" id="telpon" placeholder="Telpon..." name="telpon" value="<?= $data['telp']; ?>">
                ...
                <div class="mb-3">
                    ...
                    <select name="level" class="form-select" aria-label="Default select example" style="width:50%">
                        <?php if ($data['level'] == "masyarakat") { ?>
        ...
        <div class="position-absolute bottom-0 start-50 translate-middle-x" style="margin-bottom:60px">
            ...
            <a href="<?= BASEURL ?>home/users" class="btn btn-outline-info">BACK</a>
        </div>
    </body>
